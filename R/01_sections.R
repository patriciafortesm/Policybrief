...
#' @export
pb_about <- function(text, institution_name = "", institution_description = "",
                     license_text = "", lang = "pt") {
  paras <- paste(sapply(text, function(p) paste0("<p>", p, "</p>")), collapse = "\n")

  about_title <- if (lang == "pt") "Sobre esta publicação" else "About this publication"
